...
import { sidebarMini, toggleSidebar } from "lib/slices/layoutConfig";
import { useRouter } from "next/router";

const Sidebar = () => {
  const isActiveSideBar = useSelector((state) => state.layoutConfig.sidebar);
  ...
  return (
    <>
      <aside
        className={`sidebar sidebar-default navs-rounded-all sidebar-hover ${isActiveSideBar && "sidebar-mini"
          }`}
      >
